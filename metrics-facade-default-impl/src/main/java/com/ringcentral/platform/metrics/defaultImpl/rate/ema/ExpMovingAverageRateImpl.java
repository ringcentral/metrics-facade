package com.ringcentral.platform.metrics.defaultImpl.rate.ema;
...
public class ExpMovingAverageRateImpl extends AbstractRateImpl {
    ...
    public ExpMovingAverageRateImpl(
        ExpMovingAverageRateImplConfig config,
