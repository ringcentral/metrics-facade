...
public class DropwizardMetricRegistryDefaultInstanceSamplesProviderGaugeTest {
    ...
    public void when_number_gauge_is_registered_then_return_instance_for_it() {
        ...
        assertThat(sample.name(), equalTo("g1"));
        assertThat(sample.value(), equalTo(expectedValue));
        assertThat(sample.type(), equalTo("instant"));
    }
}