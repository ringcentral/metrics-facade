 ...
 */
public class ResetByChunksExtendedHdrHistogramImpl extends AbstractExtendedHdrHistogramImpl {
    ...
    protected ResetByChunksExtendedHdrHistogramImpl(
        HdrHistogramImplConfig config,
        AbstractHistogramImpl.MeasurementSpec measurementSpec,
    ...
    private static final class Phase {
        ...
        Phase(HdrHistogramImplConfig config, long proposedInvalidationTimeMs) {
            this.chunkResetPeriodMs = config.chunkResetPeriodMs();
            this.historySize = config.chunkCount();
            this.withHistory = this.historySize > 0;
