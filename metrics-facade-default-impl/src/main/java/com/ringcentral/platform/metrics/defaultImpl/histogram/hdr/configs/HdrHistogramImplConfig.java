...
public class HdrHistogramImplConfig extends AbstractHistogramImplConfig {

    public static final HdrHistogramImplType DEFAULT_TYPE = HdrHistogramImplType.RESET_BY_CHUNKS;
    ...
    public static final HdrHistogramImplConfig DEFAULT = new HdrHistogramImplConfig(
        DEFAULT_TYPE,
        DEFAULT_CHUNKS,
    ...
    private final HdrHistogramImplType type;
    ...
    public HdrHistogramImplConfig(
        HdrHistogramImplType type,
        int chunkCount,
    ...
    public HdrHistogramImplType type() {
        return type;
    }
