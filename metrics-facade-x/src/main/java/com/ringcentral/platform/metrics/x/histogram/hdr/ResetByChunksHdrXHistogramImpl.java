 ...
 */
public class ResetByChunksHdrXHistogramImpl extends AbstractHdrXHistogramImpl {
    ...
    public ResetByChunksHdrXHistogramImpl(
        ...
        super(
            config,
            measurables,
            measurementSpec -> new ExtendedImpl(config, measurementSpec, executor, timeMsProvider),
            executor);
    }
