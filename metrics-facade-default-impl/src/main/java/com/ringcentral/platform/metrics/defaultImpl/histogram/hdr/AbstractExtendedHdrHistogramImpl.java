...
public abstract class AbstractExtendedHdrHistogramImpl implements HistogramImpl {
    ...
    protected AbstractExtendedHdrHistogramImpl(
    ...
    protected static Recorder makeRecorder(HdrHistogramImplConfig config) {
