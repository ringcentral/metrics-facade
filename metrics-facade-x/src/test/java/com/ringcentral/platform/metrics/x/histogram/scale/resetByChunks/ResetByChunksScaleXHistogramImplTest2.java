...
public class ResetByChunksScaleXHistogramImplTest2 {
    ...
    public void scale_1_allMeasurables_neverResetBuckets() {
        ...
        for (int i = 0; i < 10; ++i) {
            ...
            assertThat(snapshot.percentileValue(PERCENTILE_15), is(1.0));
            assertThat(snapshot.percentileValue(PERCENTILE_25), is(2.0));
            assertThat(snapshot.percentileValue(PERCENTILE_35), is(3.0));
            assertThat(snapshot.percentileValue(PERCENTILE_45), is(4.0));
            assertThat(snapshot.percentileValue(PERCENTILE_50), is(5.0));
            assertThat(snapshot.percentileValue(PERCENTILE_55), is(5.0));
            assertThat(snapshot.percentileValue(PERCENTILE_70), is(7.0));
            assertThat(snapshot.percentileValue(PERCENTILE_75), is(7.0));
            assertThat(snapshot.percentileValue(PERCENTILE_80), is(8.0));
            assertThat(snapshot.percentileValue(PERCENTILE_95), is(9.0));
            assertThat(snapshot.percentileValue(PERCENTILE_99), is(9.0));
            assertThat(snapshot.percentileValue(PERCENTILE_999), is(9.0));
        ...
        for (int i = 0; i < 10; ++i) {
            ...
            assertThat(snapshot.percentileValue(PERCENTILE_99), is(19.0));
            assertThat(snapshot.percentileValue(PERCENTILE_999), is(19.0));
        ...
        for (int i = 0; i < 10; ++i) {
            ...
            assertThat(snapshot.percentileValue(PERCENTILE_1), is(1.0));
            assertThat(snapshot.percentileValue(PERCENTILE_5), is(1.0));
            assertThat(snapshot.percentileValue(PERCENTILE_15), is(4.0));
            assertThat(snapshot.percentileValue(PERCENTILE_25), is(7.0));
            assertThat(snapshot.percentileValue(PERCENTILE_35), is(10.0));
            assertThat(snapshot.percentileValue(PERCENTILE_45), is(13.0));
            assertThat(snapshot.percentileValue(PERCENTILE_50), is(15.0));
            assertThat(snapshot.percentileValue(PERCENTILE_55), is(16.0));
            assertThat(snapshot.percentileValue(PERCENTILE_70), is(21.0));
            assertThat(snapshot.percentileValue(PERCENTILE_75), is(22.0));
            assertThat(snapshot.percentileValue(PERCENTILE_80), is(24.0));
            assertThat(snapshot.percentileValue(PERCENTILE_95), is(28.0));
            assertThat(snapshot.percentileValue(PERCENTILE_99), is(29.0));
            assertThat(snapshot.percentileValue(PERCENTILE_999), is(29.0));
        ...
        for (int i = 0; i < 10; ++i) {
            ...
            assertThat(snapshot.percentileValue(PERCENTILE_99), is(39.0));
            assertThat(snapshot.percentileValue(PERCENTILE_999), is(39.0));
        ...
        for (int i = 0; i < 10; ++i) {
            ...
            assertThat(snapshot.percentileValue(PERCENTILE_1), is(1.0));
            assertThat(snapshot.percentileValue(PERCENTILE_5), is(2.0));
            assertThat(snapshot.percentileValue(PERCENTILE_15), is(7.0));
            assertThat(snapshot.percentileValue(PERCENTILE_25), is(12.0));
            assertThat(snapshot.percentileValue(PERCENTILE_35), is(17.0));
            assertThat(snapshot.percentileValue(PERCENTILE_45), is(22.0));
            assertThat(snapshot.percentileValue(PERCENTILE_50), is(25.0));
            assertThat(snapshot.percentileValue(PERCENTILE_55), is(27.0));
            assertThat(snapshot.percentileValue(PERCENTILE_70), is(35.0));
            assertThat(snapshot.percentileValue(PERCENTILE_75), is(37.0));
            assertThat(snapshot.percentileValue(PERCENTILE_80), is(40.0));
            assertThat(snapshot.percentileValue(PERCENTILE_95), is(47.0));
            assertThat(snapshot.percentileValue(PERCENTILE_99), is(49.0));
            assertThat(snapshot.percentileValue(PERCENTILE_999), is(49.0));
        ...
        for (int i = 0; i < 10; ++i) {
            ...
            assertThat(snapshot.percentileValue(PERCENTILE_5), is(21.0));
            ...
            assertThat(snapshot.percentileValue(PERCENTILE_55), is(36.0));
            assertThat(snapshot.percentileValue(PERCENTILE_70), is(41.0));
            assertThat(snapshot.percentileValue(PERCENTILE_75), is(42.0));
    ...
    static class Driver {
        public static void main(String[] args) {
            ...
            System.out.println(a[(int) (0.01 * (size - 1))] + "/" + percentile(a, 0.01));
            System.out.println(a[(int) (0.05 * (size - 1))] + "/" + percentile(a, 0.05));
            System.out.println(a[(int) (0.15 * (size - 1))] + "/" + percentile(a, 0.15));
            System.out.println(a[(int) (0.25 * (size - 1))] + "/" + percentile(a, 0.25));
            System.out.println(a[(int) (0.35 * (size - 1))] + "/" + percentile(a, 0.35));
            System.out.println(a[(int) (0.45 * (size - 1))] + "/" + percentile(a, 0.45));

            System.out.println(a[(int) (0.5 * (size - 1))] + "/" + percentile(a, 0.5));
            System.out.println(a[(int) (0.55 * (size - 1))] + "/" + percentile(a, 0.55));
            System.out.println(a[(int) (0.7 * (size - 1))] + "/" + percentile(a, 0.7));

            System.out.println(a[(int) (0.75 * (size - 1))] + "/" + percentile(a, 0.75));
            System.out.println(a[(int) (0.8 * (size - 1))] + "/" + percentile(a, 0.8));
            System.out.println(a[(int) (0.95 * (size - 1))] + "/" + percentile(a, 0.95));

            System.out.println(a[(int) (0.99 * (size - 1))] + "/" + percentile(a, 0.99));
            System.out.println(a[(int) (0.999 * (size - 1))] + "/" + percentile(a, 0.999));

            System.out.println(a[(int) (0.25 * (size - 1))]);
            System.out.println(a[(int) (0.35 * (size - 1))]);
            System.out.println(a[(int) (0.45 * (size - 1))]);
            System.out.println(a[(int) (0.5 * (size - 1))]);
            System.out.println(a[(int) (0.55 * (size - 1))]);
            System.out.println(a[(int) (0.7 * (size - 1))]);
            System.out.println(a[(int) (0.75 * (size - 1))]);
            System.out.println(a[(int) (0.8 * (size - 1))]);
            System.out.println(a[(int) (0.95 * (size - 1))]);
            System.out.println(a[(int) (0.99 * (size - 1))]);
            System.out.println(a[(int) (0.999 * (size - 1))]);
        }
    }

    public static long percentile(long[] a, double q) {
        int index = (int) Math.ceil(q * a.length);
        return a[index-1];
    }
}